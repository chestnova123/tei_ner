...
def tag_to_type(label: str):
    """
    Map a label like 'B-ARTEFACT' or 'I-CONCEPT' to its TYPE.
...
def main(
    ...
    seen = sorted({lab for seq in train_dataset["labels"] for lab in seq if lab != -100})
    print("Label IDs seen in train set:", seen)
